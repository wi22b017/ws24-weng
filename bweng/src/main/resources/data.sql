...
(UNHEX(REPLACE(UUID(),'-','')), 'LH1001', '2025-03-01 08:00:00', '2025-03-01 10:00:00',
...
(UNHEX(REPLACE(UUID(),'-','')), 'LH2002', '2025-03-01 12:00:00', '2025-03-01 14:00:00',
 (SELECT id FROM airport WHERE code='VIE'),
 (SELECT id FROM airport WHERE code='FRA'),
 (SELECT id FROM aircraft WHERE serial_number='LH54321'),
 90.00,
 CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(UNHEX(REPLACE(UUID(),'-','')), 'AF3003', '2025-03-02 09:00:00', '2025-03-02 11:30:00',
 ...
 120.00,
 CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(UNHEX(REPLACE(UUID(),'-','')), 'AF4004', '2025-03-02 15:00:00', '2025-03-02 17:00:00',
 (SELECT id FROM airport WHERE code='ZHR'),
 (SELECT id FROM airport WHERE code='CDG'),
 (SELECT id FROM aircraft WHERE serial_number='AF54321'),
 70.00,
 CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(UNHEX(REPLACE(UUID(),'-','')), 'BA5005', '2025-03-03 07:00:00', '2025-03-03 09:00:00',
 ...
 95.00,
 CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(UNHEX(REPLACE(UUID(),'-','')), 'BA6006', '2025-03-03 13:00:00', '2025-03-03 15:30:00',
 (SELECT id FROM airport WHERE code='AMS'),
 (SELECT id FROM airport WHERE code='LHR'),
